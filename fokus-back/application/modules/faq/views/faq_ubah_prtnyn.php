<div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet m-portlet--tab">
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo $url.'/aksi_ubah_pertnyn/'.$id; ?>" method="post">
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row ktgrBaru">
                    ...
                    <div class="col-12 col-md-5">
                        <input disabled required type="text" value="<?php echo $records->kategori; ?>" class="form-control inptKtgr" placeholder="Kategori"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-12 col-md-5">
                        <textarea required name="pertanyaan" class="form-control" rows="2" placeholder="Input Pertanyaan"><?php echo $records->pertanyaan; ?></textarea>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label for="example-email-input" class="col-md-2 col-sm-12 col-form-label">jawaban <span class="m--font-danger">*</span></label>
                    <div class="col-12 col-md-5">
                        <textarea required class="form-control m-input summernote" name="jawaban"><?php echo $records->jawaban; ?></textarea>
...
<a href="<?php echo $url.'/ubah_pertanyaan/'.$id; ?>" class="reload ajaxify"></a>
