<div class="row">
	<div class="col-md-12">
		<div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
			<div class="m-portlet__head">
				...
				<div class="m-portlet__head-tools">
					<ul class="m-portlet__nav">
						...
						<li class="m-portlet__nav-item">
							<a href="<?php echo base_url($url.'/ubah_alamat/'.$detsen_id); ?>" class="m-portlet__nav-link m-portlet__nav-link--icon ajaxify">
			...
			<hr>
			<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/aksi_ubah_alamat/'.$detsen_id); ?>" method="POST" data-confirm="1" >
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8">
							<div class="input-group">
								<input value="<?php echo $records->detsen_judul; ?>" required type="text" name="detsen_judul" class="form-control m-input" placeholder="Judul Alamat ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->detsen_koordinat_long; ?>" required type="text" name="detsen_koordinat_long" class="form-control m-input" placeholder="Koordinat Long ... ">
							</div>
						...
						<div class="col-md-3">
							<div class="input-group">
							<input value="<?php echo $records->detsen_kotaprov; ?>" required type="text" name="detsen_kotaprov" class="form-control m-input" placeholder="Kota & Provinsi ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->detsen_koordinat_lat; ?>" required type="text" name="detsen_koordinat_lat" class="form-control m-input" placeholder="Koordinat Lat ... ">
							</div>
						...
						<div class="col-md-3">
							<div class="input-group">
							<input value="<?php echo $records->detsen_kodepos; ?>" required type="number" name="detsen_kodepos" class="form-control m-input" placeholder="Kode Pos ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-md-8">
							<div class="input-group">
								<textarea required name="detsen_alamat" class="form-control m-input alamat"><?php echo $records->detsen_alamat; ?></textarea>
							</div>
...
<a href="<?php echo base_url($url.'/ubah_alamat/'.$detsen_id); ?>" class="reload ajaxify"></a>
