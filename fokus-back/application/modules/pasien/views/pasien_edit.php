			...
			<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/action_edit/'.$user_id); ?>" method="POST" data-confirm="1" >
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->user_nama; ?>" required type="text" name="user_nama" class="form-control m-input" placeholder="Nama Pasien ... ">
							</div>
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->user_email; ?>" required type="email" name="user_email" class="form-control m-input" placeholder="Email ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->user_detkes_usia; ?>" type="number" name="user_detkes_usia" class="form-control m-input" placeholder="Usia ... ">
							</div>
						</div>
					</div>
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-3">
							<div class="row align-items-center">
								<div class="col-6"><input value="<?php echo $records->user_temlahir; ?>" required type="text" class="form-control m-input " placeholder="Tempat" name="user_temlahir" ></div>
								<div class="col-6"><input value="<?php echo date('d-m-Y',strtotime($records->user_tgllahir)); ?>" required type="text" class="form-control m-input tgllahir" placeholder="Tanggal" name="user_tgllahir"></div>
							</div>
							<span class="m-form__help"></span>
						</div>
						...
						<div class="col-lg-3">
							<div class="input-group">
								<input value="<?php echo $records->user_nohp; ?>" type="number" name="user_nohp" class="form-control m-input" placeholder="No HP ... ">
							</div>
						</div>
					</div>
				</div>
