			...
			<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/action_add'); ?>" method="POST" >
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-6">
							<div class="input-group">
								<input required type="text" name="api_nama" class="form-control m-input" placeholder="Nama API ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-6">
							<div class="input-group">
								<input required type="text" name="api_link" class="form-control m-input" placeholder="Link API ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-6">
							<textarea required name="api_keterangan" class="form-control m-input pengalaman" placeholder="Keterangan ... "></textarea>
