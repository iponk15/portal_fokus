		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					...
					<a href="<?php echo base_url('api/konfig_api'); ?>" class="btn btn-outline-info m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air ajaxify" title="Konfigurasi Auth API">
...
<script type="text/javascript">
	function showModal(a){
		var url = base_url + 'api/preview';
		var dta = { 'api_id' : $(a).attr('data-id') };
	...
	$(document).ready(function($) {
		...
		var column = [
			...
			{ field: "api_nama",title: "Nama", width: 150}, 
			{ field: "api_tipe",title: "Tipe", width: 90,textAlign: 'center'}, 
			{ field: "api_link",title: "Link", width: 650}, 
