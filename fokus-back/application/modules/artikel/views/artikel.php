...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		var column = [
			...
			{ field: "artikel_judul",title: "Judul", width: 140}, 
			{ field: "artikel_ringkasan",title: "Ringkasan", width: 150}, 
			{ field: "artikel_tipe",title: "Tipe", width: 150}, 
			{ field: "kategori_nama",title: "Kategori", width: 200}, 
			{ field: "penulis_status",title: "Status", width: 90,textAlign: 'center'}, 
			{ field: "artikel_lastupdate",title: "Terakhir Update", width: 200}, 
