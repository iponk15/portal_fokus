						...
						<div class="m-portlet m-portlet--primary m-portlet--head-solid-bg m-portlet--head-sm" m-portlet="true" id="m_portlet_tools_2">
							...
							<div class="m-portlet__body">
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-5">
										<div class="input-group">
											<input required type="text" name="penulis_nama" class="form-control m-input" placeholder="Nama Penulis ... ">
										</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-5">
										<div class="input-group">
											<input required type="email" name="penulis_email" class="form-control m-input" placeholder="Email ... ">
										</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-5">
										<div class="input-group">
											<input required type="number" name="penulis_nohp" class="form-control m-input" placeholder="Nomer HP ... ">
										</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-10">
										<textarea name="penulis_alamat" class="form-control m-input" placeholder="Alamat ... "></textarea>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-10">
										<textarea name="penulis_deskripsi" class="form-control m-input penulis_deskripsi" placeholder="Deskripsi ... "></textarea>
