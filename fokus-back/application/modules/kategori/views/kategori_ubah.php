<div class="row">
	<div class="col-md-12">
		<div class="m-portlet m-portlet--creative m-portlet--first m-portlet--bordered-semi">
			<div class="m-portlet__head">
				...
				<div class="m-portlet__head-tools">
					<ul class="m-portlet__nav">
						...
						<li class="m-portlet__nav-item">
							<a href="<?php echo base_url($url.'/tampil_ubah/'.$kategori_id); ?>" class="m-portlet__nav-link m-portlet__nav-link--icon ajaxify">
			...
			<hr>
			<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/aksi_ubah/'.$kategori_id); ?>" method="POST" form-confirm="1">
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-4">
							<div class="input-group">
								<input disabled value="<?php echo $records->kategori_kode ?>" type="text" name="kategori_kode" class="form-control m-input" placeholder="Kode Kategori ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-4">
							<div class="input-group">
								<input value="<?php echo $records->kategori_nama ?>" required type="text" name="kategori_nama" class="form-control m-input" placeholder="Nama Kategori ... ">
							</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-4">
							<textarea name="kategori_deskripsi" class="form-control m-input" placeholder="Deskripsi ... " rows="6"> <?php echo $records->kategori_deskripsi; ?> </textarea>
...
<a href="<?php echo base_url($url.'/tampil_ubah/'. $kategori_id); ?>" class="reload ajaxify"></a>
