		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="<?php echo base_url('menu/show_add') ?>" class="btn btn-outline-success m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air ajaxify">
					<span>
...
<script type="text/javascript">
	$(document).ready(function() {
		var clas   = '.datatable';
		var urll   = '<?php echo base_url("menu/get_data"); ?>';
		var column = [
			{ field: "no",title: "No. ",sortable: false,width: 30,textAlign: 'center'}, 
			{ field: "menu_nama",title: "Menu",filterable: true,width: 80,textAlign: 'center'}, 
			{ field: "menu_controllers",title: "Controllers",filterable: true,width: 250}, 
			{ field: "menu_is_primary",title: "Is Primary",filterable: true,width: 80,textAlign: 'center'}, 
			{ field: "menu_status",title: "Status",filterable: true,width: 70,textAlign: 'center'}, 
		...
		var cari = {generalSearch :'.generalSearch'};
	 	...
	 	global.init_select2('.select2_status','Select Status');
	});
</script>