			...
			<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/action_add') ?>" method="post">
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-4">
							<input class="form-control m-input" type="text" name="layanan_nama" placeholder="Nama Layanan ...">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-text-input" class="col-3 col-form-label">Harga Layanan <span class="m--font-danger">*</span></label>
						<div class="col-4">
							<input class="form-control m-input" type="number" name="layanan_harga" placeholder="Harga Layanan ..." min="0">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-text-input" class="col-3 col-form-label">Keterangan </label>
						<div class="col-4">
							<textarea name="layanan_keterangan" class="form-control m-input" rows="10" placeholder="Keterangan ..."></textarea>
						</div>
					</div>
				</div>
