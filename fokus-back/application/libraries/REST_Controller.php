...
abstract class REST_Controller extends \CI_Controller {
    ...
    protected function _detect_api_key()
    {
        ...
        if(empty(isset($this->_args[$api_key_variable]))){
            $this->response([
                $this->config->item('rest_status_field_name') => FALSE,
        ...
        $where  = ['homed_key' => $api_key_variable, $this->config->item('rest_key_column') => $key];
        $getKey = $this->m_global->get('keys',null,$where);
