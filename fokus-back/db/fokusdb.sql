...
CREATE TABLE `fokus_admin`  (
  ...
  `admin_nama` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_email` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_password` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_salt` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `admin_createdby` int(11) DEFAULT NULL,
  `admin_createddate` int(11) DEFAULT NULL,
  ...
  `admin_token` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `admin_username` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_terakhir_login` int(11) DEFAULT NULL,
  ion2 `admin_kode_aktivasi` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_kode_lupapas` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ion2 `admin_waktu_lupapas` int(11) DEFAULT NULL,
  ion2 `admin_kode_ingat` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `admin_namadepan` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `admin_namabelakang` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fokus_admin` VALUES (22, 1, 'test', 'irfan.isma@gmail.com', '$2y$08$dKedju/Nuaul5TElPR8qt.Koi.11m2QGrUi.JAL0ZE/BqC02Qcd8O', 'gt9esijJhCFgqlBctIxw6e', '08973950031', NULL, '1', NULL, '1', NULL, 2018, '2018-10-03 21:46:23', NULL, '::1', NULL, NULL, 1539126858, NULL, NULL, NULL, 'HVkrqdzlPyV2ZKm3hZY9EO', NULL, NULL);
INSERT INTO `fokus_admin` VALUES (24, NULL, NULL, 'a@a.com', NULL, NULL, NULL, NULL, '1', NULL, '1', NULL, NULL, '2018-10-04 15:36:29', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$08$oyO5Tp83BL9hYh5e6GlRKeSJhr9kw7tyg', 1538642191, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for fokus_artikel
-- ----------------------------
DROP TABLE IF EXISTS `fokus_artikel`;
CREATE TABLE `fokus_artikel`  (
  `artikel_id` int(11) NOT NULL AUTO_INCREMENT,
  `artikel_judul` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `artikel_ringkasan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `artikel_keterangan` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `artikel_tipe` enum('1','2','3','4','5') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '1=default,2=video,3=audio,4=galeri,5=gambar',
  `artikel_penulisid` int(11) DEFAULT NULL,
  `artikel_tanggalbuat` datetime(0) DEFAULT NULL,
  `artikel_kategoriId` int(255) DEFAULT NULL,
  `artikel_tagid` int(11) DEFAULT NULL,
  `artikel_lastupdate` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `artikel_kover` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci COMMENT 'untuk menampung gambar kover artikel dalam bentuk json',
  `artikel_media` text CHARACTER SET latin1 COLLATE latin1_swedish_ci COMMENT 'default,video,audio dan gambar',
...
CREATE TABLE `fokus_group`  (
  ...
  `group_status` enum('0','1') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '1' COMMENT '0 = off, 1 = on',
  ...
  `group_userid` int(11) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fokus_group` VALUES (1, 1, 'Superadmin', 'Group Superadmin', '::1', '[{\"menu_id\":\"1\",\"menu_nama\":\"Welcome\",\"menu_controllers\":[],\"menu_is_primary\":1,\"menu_url\":\"welcome\",\"menu_sub_menu\":[]},{\"menu_id\":\"9\",\"menu_nama\":\"Konfigurasi\",\"menu_controllers\":[\"group\",\"icon\",\"menu\",\"role\"],\"menu_is_primary\":0,\"menu_url\":\"\",\"menu_sub_menu\":[{\"text\":\"Group\",\"icon_menu\":\"users\",\"controller\":\"group\",\"parent\":9},{\"text\":\"Icon\",\"icon_menu\":\"medical\",\"controller\":\"icon\",\"parent\":9},{\"text\":\"Menu\",\"icon_menu\":\"puzzle\",\"controller\":\"menu\",\"parent\":9},{\"text\":\"Role\",\"icon_menu\":\"web\",\"controller\":\"role\",\"parent\":9}]},{\"menu_id\":\"10\",\"menu_nama\":\"Master Data\",\"menu_controllers\":[\"penulis\",\"artikel\",\"kategori\",\"tag\"],\"menu_is_primary\":\"\",\"menu_url\":\"\",\"menu_sub_menu\":[{\"text\":\"Penulis\",\"icon_menu\":\"book\",\"controller\":\"penulis\",\"parent\":10},{\"text\":\"Artikel\",\"icon_menu\":\"web\",\"controller\":\"artikel\",\"parent\":10},{\"text\":\"Kategori\",\"icon_menu\":\"confetti\",\"controller\":\"kategori\",\"parent\":10},{\"text\":\"Tag\",\"icon_menu\":\"attachment\",\"controller\":\"tag\",\"parent\":10}]}]', '[\"welcome\",\"group\",\"icon\",\"menu\",\"role\",\"penulis\",\"artikel\",\"kategori\",\"tag\",null]', '1', '111111', '2018-03-22 10:45:23', '1', '2018-09-05 06:39:56', NULL);
INSERT INTO `fokus_group` VALUES (2, 2, 'Penulis', 'group penulis', NULL, NULL, NULL, '1', NULL, NULL, NULL, '2018-10-02 09:10:42', NULL);
INSERT INTO `fokus_group` VALUES (3, NULL, 'Test', 'hahah', NULL, NULL, NULL, '1', NULL, NULL, NULL, '2018-10-02 10:21:54', NULL);
INSERT INTO `fokus_group` VALUES (4, NULL, 'aa', 'aa', NULL, NULL, NULL, '1', NULL, NULL, NULL, '2018-10-02 10:23:14', NULL);
...
-- ----------------------------
-- Table structure for fokus_kategori
-- ----------------------------
DROP TABLE IF EXISTS `fokus_kategori`;
CREATE TABLE `fokus_kategori`  (
  `kategori_id` int(11) NOT NULL AUTO_INCREMENT,
  `kategori_kode` varchar(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `kategori_status` enum('0','1') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '1' COMMENT '0=off,1=on',
  ...
  `kategori_updatedby` int(11) DEFAULT NULL,
  `kategori_ip` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`kategori_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of fokus_kategori
-- ----------------------------
INSERT INTO `fokus_kategori` VALUES (1, 'PLT', 'Politik', 'ini kategori politik  ', '1', NULL, NULL, '2018-09-04 22:55:59', 1, '::1');
INSERT INTO `fokus_kategori` VALUES (3, 'ENT', 'Entertainment', 'Entertainment', '1', 1, '2018-09-05 05:55:55', '2018-09-05 05:55:55', NULL, '::1');
INSERT INTO `fokus_kategori` VALUES (4, 'HBR', 'HIburan', 'Kategori hiburan', '1', 1, '2018-09-05 06:06:22', '2018-09-05 06:06:22', NULL, '::1');

-- ----------------------------
-- Table structure for fokus_login_attempts
-- ----------------------------
DROP TABLE IF EXISTS `fokus_login_attempts`;
CREATE TABLE `fokus_login_attempts`  (
...
INSERT INTO `fokus_menu` VALUES (10, 'Master Data', '[\"penulis\",\"artikel\",\"kategori\",\"tag\"]', NULL, NULL, '[{\"parent\":\"10\",\"order\":\"1\",\"text\":\"Penulis\",\"icon_menu\":\"book\",\"icon\":\"fa fa-glass m--font-success\",\"controller\":\"penulis\"},{\"parent\":\"10\",\"order\":\"2\",\"text\":\"Artikel\",\"icon_menu\":\"web\",\"icon\":\"fa fa-glass m--font-success\",\"controller\":\"artikel\"},{\"parent\":\"10\",\"order\":\"3\",\"text\":\"Kategori\",\"icon_menu\":\"confetti\",\"icon\":\"fa fa-glass m--font-success\",\"controller\":\"kategori\"},{\"parent\":\"10\",\"order\":\"4\",\"text\":\"Tag\",\"icon_menu\":\"attachment\",\"icon\":\"fa fa-glass m--font-success\",\"controller\":\"tag\"}]', '1', '::1', '1', '2018-08-26 11:19:16', '1', '2018-09-05 06:39:47');

-- ----------------------------
-- Table structure for fokus_penulis
-- ----------------------------
DROP TABLE IF EXISTS `fokus_penulis`;
CREATE TABLE `fokus_penulis`  (
  `penulis_id` int(11) NOT NULL AUTO_INCREMENT,
  `penulis_nama` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `penulis_email` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `penulis_salt` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `penulis_password` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `penulis_nohp` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `penulis_alamat` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `penulis_deskripsi` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `penulis_foto` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `penulis_sosmed` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `penulis_status` enum('0','1') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '1' COMMENT '0=off,1=on',
  `penulis_createdby` int(11) DEFAULT NULL,
  `penulis_createddate` datetime(0) DEFAULT NULL,
  `penulis_lastupdate` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  `penulis_updatedby` int(11) DEFAULT NULL,
  `penulis_ip` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`penulis_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of fokus_penulis
-- ----------------------------
INSERT INTO `fokus_penulis` VALUES (1, 'Irfan Isma Somantri', 'irfan.isma@gmail.com', NULL, NULL, '08973950031', 'Jl. Lenteng Agung, Jakarta Selatan', 'hobi saya menulis artikel', 'assets/app/media/img/penulis/Irfan_Isma_Somantri065010.jpeg', '{\"linkedin\":\"linkedin\",\"facebook\":\"facebook\",\"twitter\":\"twitter\",\"instagram\":\"instagram\"}', '1', 1, '2018-09-05 06:50:10', '2018-09-05 06:50:10', NULL, '::1');
INSERT INTO `fokus_penulis` VALUES (2, 'Hasan', 'hasan@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, '2018-09-15 19:12:34', NULL, NULL);

-- ----------------------------
-- Table structure for fokus_relasigroup
-- ----------------------------
DROP TABLE IF EXISTS `fokus_relasigroup`;
CREATE TABLE `fokus_relasigroup`  (
  `regroup_id` int(11) NOT NULL AUTO_INCREMENT,
  `regroup_userid` int(11) DEFAULT NULL,
  `regroup_groupid` int(11) DEFAULT NULL,
  PRIMARY KEY (`regroup_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of fokus_relasigroup
-- ----------------------------
INSERT INTO `fokus_relasigroup` VALUES (2, 1, 1);
INSERT INTO `fokus_relasigroup` VALUES (3, 6, 2);
INSERT INTO `fokus_relasigroup` VALUES (4, 7, 1);
...
-- ----------------------------
-- Table structure for fokus_tag
-- ----------------------------
DROP TABLE IF EXISTS `fokus_tag`;
CREATE TABLE `fokus_tag`  (
  `tag_id` int(11) NOT NULL AUTO_INCREMENT,
  `tag_nama` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`tag_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of fokus_tag
-- ----------------------------
INSERT INTO `fokus_tag` VALUES (1, '#news');
...
CREATE TABLE `fokus_user`  (
  ...
  `user_username` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `user_last_login` datetime(0) DEFAULT NULL,
