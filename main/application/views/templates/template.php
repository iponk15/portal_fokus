...
<head>
    ...
    <title>Fokus - Portal Berita</title>  
    ...
    <link href="<?php echo base_url(); ?>assets/css/slicknav.min.css" rel="stylesheet" type="text/css"/>
...
<body>
	...
	<div id="wrapper">
					...
					<div class="top_bar margin-15">
						<div class="row">
							<div class="col-md-6 col-sm-12 time">
								...
								<i class="fa fa-clock-o"></i><span>&nbsp;&nbsp;&nbsp;Friday, 5 January 2018</span>               
							</div>
							...
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									...
									<div class="alith_post_title_small">
										...
										<p class="meta"><span>2 Sep, 2018</span> <span>90 views</span></p>
									</div>
								</div>
							</div>
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									<figure class="alith_post_thumb">
										<a href="single.html"><img src="http://via.placeholder.com/100x100" alt=""/></a>
									</figure>
									<div class="alith_post_title_small">
										<a href="single.html"><strong>Ut enim ad minima veniam </strong></a>
										<p class="meta"><span>28 Aug, 2018</span> <span>78 views</span></p>
									</div>
								</div>
							</div>
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									...
									<div class="alith_post_title_small">
										...
										<p class="meta"><span>16 Aug, 2018</span> <span>112 views</span></p>
									</div>
								</div>
							</div>
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									...
									<div class="alith_post_title_small">
										...
										<p class="meta"><span>15 Jun, 2018</span> <span>328 views</span></p>
									</div>
								</div>
							</div>
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									...
									<div class="alith_post_title_small">
										...
										<p class="meta"><span>21 Sep, 2018</span> <span>178 views</span></p>
									</div>
								</div>
							</div>
							<div class="item px-2">
								<div class="alith_latest_trading_img_position_relative">
									...
									<div class="alith_post_title_small">
										...
										<p class="meta"><span>22 Aug, 2018</span> <span>268 views</span></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-8">
							<div class="owl-carousel owl-theme js section_margin line_hoz animate-box" id="slideshow_face">
								<div class="item">
									<figure class="alith_post_thumb_big">
										<span class="post_meta_categories_label">Legal, Blog</span>
										<a href="single.html"><img src="http://via.placeholder.com/797x589" alt=""/></a>
									</figure>
										...
										<div class="row">
											<div class="col-md-4 col-sm-12">
												<div class="post_meta_center animate-box">
													...
													<span class="post_meta_date">19 Sep, 2018</span>
												</div>
											</div>
								...
								<div class="item">
									<figure class="alith_post_thumb_big">
										...
										<a href="#"><img src="http://via.placeholder.com/797x589" alt=""/></a>
									</figure>
									<h3 class="alith_post_title animate-box" data-animate-effect="fadeInUp">
										<a href="single.html">Lorem ipsum dui sollic itudin praesent ut mollis primis eros torquent fames</a>
									</h3>
										...
										<div class="row">
											<div class="col-md-4 col-sm-12">
												<div class="post_meta_center animate-box">
													<p><a href="page-author.html"><img src="assets/images/author-avatar.png" alt="author details"/></a></p>
													<p><a href="page-author.html" class="author"><strong>Steven Job</strong></a></p>
													<span class="post_meta_date">21 Sep, 2018</span>
												</div>
											</div>
											<div class="col-md-8 col-sm-12 animate-box">
												<p class="alith_post_except">Is very common and rather normal for blogging beginners to be highly perplexed when it comes to selecting a theme for their blog. There are a plethora of free as well as paid options.</p>
										...
										<div class="row">
											<div class="col-md-4 col-sm-12">
												<div class="post_meta_center animate-box">
													<p><a href="page-author.html"><img src="assets/images/author-avatar.png" alt="author details"/></a></p>
													<p><a href="page-author.html" class="author"><strong>Steven Job</strong></a></p>
													<span class="post_meta_date">23 Sep, 2018</span>
												</div>
											</div>
											<div class="col-md-8 col-sm-12 animate-box">
												<p class="alith_post_except">Is very common and rather normal for blogging beginners to be highly perplexed when it comes to selecting a theme for their blog. There are a plethora of free as well as paid options.</p>
							...
							<div class="post_list post_list_style_1">
								...
								<article class="row section_margin animate-box">
									<div class="col-md-3 animate-box">							
										<figure class="alith_news_img"><a href="single.html"><img src="http://via.placeholder.com/500x400" alt=""/></a></figure>
									</div>
			...
			<div class="container-fluid alith_footer_right_reserved">
				<div class="container">
					<div class="row">
						...
						<div class="col-12 col-md-12 coppyright"> <p>© Copyright 2018, All rights reserved. Design by <a href="https://alithemes.com" title="AliTheme">Alithemes.com</a></p> </div>
					</div>
				</div>
			</div>
		...
		<script src="<?php echo base_url(); ?>assets/js/smart-sticky.js"></script>
